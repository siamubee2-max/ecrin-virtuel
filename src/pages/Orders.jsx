    ...
    <div className="max-w-4xl mx-auto space-y-8 p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-neutral-500">Track and manage your recent purchases.</p>
        </div>
                ...
                <CardHeader className="bg-neutral-50 border-b border-neutral-100 py-3">
                  <div className="flex flex-wrap items-center justify-between gap-4">
                    <div className="space-y-1">
                      <p className="text-xs text-neutral-500 uppercase tracking-wider">Order Placed</p>
                    ...
                    <div className="flex-1 space-y-2">
                       ...
                       {order.tracking_number && (
                         <div className="pt-2">
                            ...
                            <p className="text-sm text-amber-600 font-mono bg-amber-50 inline-block px-2 py-1 rounded mt-1">{order.tracking_number}</p>
                         </div>
                       )}
                    </div>
                    <div className="md:text-right space-y-1">
                       <p className="text-sm font-medium">Shipping to:</p>
                       <p className="text-sm text-neutral-600 whitespace-pre-line">{order.shipping_address}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
