...
const translations = {
  fr: {
    nav: {
      ...
      stylePrefs: "Préférences Style",
      history: "Historique",
      wishlist: "Ma Liste",
      name: "Nom complet",
      email: "Email",
      bio: "Biographie",
      bioPlaceholder: "Dites-nous en plus sur votre style...",
      saved: "Enregistré !",
      save: "Enregistrer les modifications",
      favColors: "Couleurs Favorites",
      favTypes: "Types de Bijoux Favoris",
      occasions: "Occasions Fréquentes",
  ...
  en: {
    ...
    profile: {
      ...
      stylePrefs: "Style Prefs",
      history: "History",
      wishlist: "Wishlist",
      name: "Full Name",
      email: "Email",
      bio: "Bio",
      bioPlaceholder: "Tell us more about your style...",
      saved: "Saved!",
      save: "Save Changes",
      favColors: "Favorite Colors",
      favTypes: "Favorite Jewelry Types",
      occasions: "Frequent Occasions",
  ...
  es: {
    ...
    profile: {
      title: "Mi Perfil",
      subtitle: "Gestiona tu información personal y preferencias de estilo.",
      personalInfo: "Info Personal",
      stylePrefs: "Prefs de Estilo",
      history: "Historial",
      wishlist: "Lista de Deseos",
      name: "Nombre Completo",
      email: "Email",
      bio: "Biografía",
      bioPlaceholder: "Cuéntanos más sobre tu estilo...",
      saved: "¡Guardado!",
      save: "Guardar Cambios",
      favColors: "Colores Favoritos",
      favTypes: "Tipos de Joyas Favoritos",
      occasions: "Ocasiones Frecuentes",
  ...
  de: {
    ...
    profile: {
      title: "Mein Profil",
      subtitle: "Verwalten Sie Ihre persönlichen Daten und Stilpräferenzen.",
      personalInfo: "Persönliche Infos",
      stylePrefs: "Stilpräferenzen",
      history: "Verlauf",
      wishlist: "Wunschliste",
      name: "Vollständiger Name",
      email: "E-Mail",
      bio: "Biografie",
      bioPlaceholder: "Erzählen Sie uns mehr über Ihren Stil...",
      saved: "Gespeichert!",
      save: "Änderungen speichern",
      favColors: "Lieblingsfarben",
      favTypes: "Lieblingsschmuckarten",
      occasions: "Häufige Anlässe",
  ...
  it: {
    ...
    profile: {
      ...
      subtitle: "Gestisci le tue informazioni personali e le preferenze di stile.",
      personalInfo: "Info Personali",
      stylePrefs: "Pref. di Stile",
      history: "Cronologia",
      wishlist: "Lista dei Desideri",
      name: "Nome Completo",
      email: "Email",
      bio: "Biografia",
      bioPlaceholder: "Raccontaci di più sul tuo stile...",
      saved: "Salvato!",
      save: "Salva Modifiche",
      favColors: "Colori Preferiti",
      favTypes: "Tipi di Gioielli Preferiti",
      occasions: "Occasioni Frequenti",
  ...
  pt: {
    ...
    profile: {
      title: "Meu Perfil",
      subtitle: "Gerencie suas informações pessoais e preferências de estilo.",
      ...
      email: "Email",
      bio: "Biografia",
      bioPlaceholder: "Conte-nos mais sobre seu estilo...",
      saved: "Salvo!",
      save: "Salvar Alterações",
      favColors: "Cores Favoritas",
      favTypes: "Tipos de Joias Favoritos",
      occasions: "Ocasiões Frequentes",
