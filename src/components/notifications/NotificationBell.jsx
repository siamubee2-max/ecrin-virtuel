              ...
              {notifications.map((notification) => (
                ...
                >
                  <div className={cn(
                    ...
                    !notification.read ? "bg-amber-500" : "bg-neutral-200"
                  )} />
                  <div className="space-y-1 flex-1">
                    <p className={cn("text-sm", !notification.read ? "font-semibold text-neutral-900" : "font-medium text-neutral-700")}>
                      {notification.title}
                    </p>
                    ...
                    <p className="text-[10px] text-neutral-400">
                      {notification.created_at && formatDistanceToNow(new Date(notification.created_at), { addSuffix: true, locale })}
                    </p>
                  </div>
                </div>
              ))}
